'''
description:
define the parameterization for a two-finger configuration with contact points (torch version)
...
class PalmCage:
    ...
    def get_handle_positions(self):
        ...
        handle_positions[0, 0], handle_positions[1, 0], handle_positions[2, 0] = -self.length / 2., -self.side_parent.width / 2., -self.side_parent.height / 2.
        handle_positions[0, 1], handle_positions[1, 1], handle_positions[2, 1] = -self.length / 2., -self.side_parent.width / 2., self.side_parent.height / 2.
        handle_positions[0, 2], handle_positions[1, 2], handle_positions[2, 2] = -self.length / 2., self.side_parent.width / 2., -self.side_parent.height / 2.
        handle_positions[0, 3], handle_positions[1, 3], handle_positions[2, 3] = -self.length / 2., self.side_parent.width / 2., self.side_parent.height / 2.
        handle_positions[0, 4], handle_positions[1, 4], handle_positions[2, 4] = self.length / 2., -self.side_child.width / 2., -self.side_child.height / 2.
        handle_positions[0, 5], handle_positions[1, 5], handle_positions[2, 5] = self.length / 2., -self.side_child.width / 2., self.side_child.height / 2.
        handle_positions[0, 6], handle_positions[1, 6], handle_positions[2, 6] = self.length / 2., self.side_child.width / 2., -self.side_child.height / 2.
        handle_positions[0, 7], handle_positions[1, 7], handle_positions[2, 7] = self.length / 2., self.side_child.width / 2., self.side_child.height / 2.
