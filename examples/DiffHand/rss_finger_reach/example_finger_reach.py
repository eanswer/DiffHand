...
if __name__ == '__main__':
    ...
    parser.add_argument('--record-file-name', type = str, default = 'rss_finger_reach')
    ...
    if not play_mode:
        ...
        res = scipy.optimize.minimize(loss_and_grad, np.copy(params), method = "L-BFGS-B", jac = True, callback = callback_func, bounds = bounds, options={'maxiter': 500})
