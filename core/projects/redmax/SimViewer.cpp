...
void SimViewer::initialize() {
    ...
    if (_sim->_viewer_options->_camera_up[1] > 0.5) {
        light_option.SetVectorOption("ambient", 0.27f, 0.25f, 0.24f);
        light_option.SetVectorOption("diffuse", 0.17f, 0.15f, 0.14f);
        light_option.SetVectorOption("specular", 0.37f, 0.35f, 0.34f);
        const Eigen::Vector3f light0_position(-0.5f, 1.5f, -0.5f);
        viewer.AddStaticPointLight(light0_position, light_option);
        const Eigen::Vector3f light1_position(-0.5f, 1.5f, 0.5f);
        viewer.AddStaticPointLight(light1_position, light_option);
        const Eigen::Vector3f light2_position(0.5f, 1.5f, -0.5f);
        viewer.AddStaticPointLight(light2_position, light_option);
        const Eigen::Vector3f light3_position(0.5f, 1.5f, 0.5f);
        viewer.AddStaticPointLight(light3_position, light_option);
    } else {
        light_option.SetVectorOption("ambient", 0.27f, 0.25f, 0.24f);
        light_option.SetVectorOption("diffuse", 0.37f, 0.35f, 0.34f);
        light_option.SetVectorOption("specular", 0.37f, 0.35f, 0.34f);
        const Eigen::Vector3f light0_position(-1.f, -1.f, (float)_sim->_viewer_options->_E_g(2, 3) + 2.2);
        viewer.AddStaticPointLight(light0_position, light_option);
        const Eigen::Vector3f light1_position(-1.f, 1.f, (float)_sim->_viewer_options->_E_g(2, 3) + 2.2);
        viewer.AddStaticPointLight(light1_position, light_option);
        const Eigen::Vector3f light2_position(1.f, -1.f, (float)_sim->_viewer_options->_E_g(2, 3) + 2.2);
        viewer.AddStaticPointLight(light2_position, light_option);
        const Eigen::Vector3f light3_position(1.f, 1.f, (float)_sim->_viewer_options->_E_g(2, 3) + 2.2);
        viewer.AddStaticPointLight(light3_position, light_option);
    }
