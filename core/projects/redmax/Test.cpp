...
void Test::test_xml_reader() {
    Simulation* sim = new Simulation("../../assets/finger_torque.xml");
    // Simulation* sim = new Simulation("../../assets/rss_two_finger_assemble.xml");
...
void Test::test_speed() {
    Simulation* sim = new Simulation("../../assets/rss_finger_flip.xml");
...
void Test::test_forward() {
    ...
    Simulation* sim = SimEnvGenerator::createTorqueFingerFlickDemo();
...
void Test::test_derivative() {
    ...
    Simulation* sim = new Simulation("/home/eanswer/Workspace/Projects/RoboticHand/code/RoboticHandDesign/RedMax/assets/finger_mesh.xml");
...
void Test::test_design_derivative() {
    // Simulation* sim = new Simulation("/home/eanswer/Workspace/Projects/RoboticHand/code/RoboticHandDesign/RedMax/assets/double_pendulum_design_1.xml");
    // Simulation* sim = new Simulation("/home/eanswer/Workspace/Projects/RoboticHand/code/RoboticHandDesign/RedMax/assets/double_pendulum_design.xml");
    // Simulation* sim = new Simulation("/home/eanswer/Workspace/Projects/RoboticHand/code/RoboticHandDesign/RedMax/assets/double_pendulum_contact_design.xml");
    Simulation* sim = new Simulation("/home/eanswer/Workspace/Projects/RoboticHand/code/RoboticHandDesign/RedMax/assets/abstract_finger.xml");
    // Simulation* sim = new Simulation("/home/eanswer/Workspace/Projects/RoboticHand/code/RoboticHandDesign/RedMax/assets/new_finger.xml");
